...
//error_reporting(0);
 date_default_timezone_set('Europe/Madrid');
	...
	if (isset($_POST["questionrandom"])) $questionrandom=$_POST["questionrandom"];
	elseif (isset($_GET["questionrandom"])) $questionrandom=$_GET["questionrandom"];
	else $questionrandom=0;
