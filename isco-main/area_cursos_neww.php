...
*/
   ...
   $i=1;
    ...
    foreach($res['temas'] as $temas) {
      ...
      //echo $mystring." : ".$pos_no_ver;
      if (($pos_m1 === false) && ($pos_m2=== false) && ($pos_m3=== false)&& ($pos_m4=== false)&& ($pos_m5=== false)&& ($pos_m6=== false)){
              ...
              <div class="card mb-3">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <?php if  ($i != 0){?>
                      <h5 class="mb-0" data-anchor="data-anchor" id="circular"><?php echo $tema[$i]['nombre'];?><a class="anchorjs-link " aria-label="Anchor" data-anchorjs-icon="Acceder" href="#" style="padding-left: 0.375em;"></a></h5>
                      <?php }else{?>
                  ...
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active show" role="tabpanel" aria-labelledby="tab-dom-f9f160af-450d-417a-a0d4-ff7e9eed30c6" id="dom-f9f160af-450d-417a-a0d4-ff7e9eed30c6">
                      ...
                      <div class="grid-container">
                        ...
                        <?php if  ($i != 0){?>
                        <img src="assets/img/otro_icons/pngwing.com.png" alt="">
                        <?php }?>
                           </div>                       
                           <?php if  ($i != 0){?>  
                           <div class="d-flex align-items-center">
                              <div class="progress me-3 rounded-3 bg-200" style="height: 5px; width:400px;" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
                            ...
                            <?php }else{?>
                                <div class="d-flex align-items-center">
                              <div class="progress me-3 rounded-3 bg-200" style="height: 5px; width:400px;" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
                                <div class="progress-bar rounded-pill" style="width: 50%;"></div>
                              </div>
                              <div class="fw-semi-bold ms-2">50%</div>
                            </div>                               
                            <?php }?>      
                    </div>
                    </div>
