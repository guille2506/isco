...
<label for="curse"><strong>Categoria</strong></label>
...
$parametros="categoria=1"; //old
//$parametros="categoria=69"; //new
...
<select id="courseid" name="courseid"  class="form-control show-tick" data-live-search="true" required onchange="cargarCursosTemas(this.value,<?PHP echo $c=1; ?>)">
<?PHP 
echo"<option value=''>Seleccione...</option>";
...
<div class="col-md-6">
<div id="tema" class="form-group">
<label for="coursesectionsid"><strong>Temas</strong></label>
<select id="coursesectionsid" name="coursesectionsid" class="form-control show-tick" data-live-search="true" required onchange="this.form.submit()">
...
$parametros3="qtype=2&userid=".$userid."&quizid=".$tupl1["instance"];
