...
//die();
   ...
   $i=1;
    ...
    foreach($res['items'] as $items_tema) {
      // encuesta final
      if ($items_tema['name']=="forum"){
        $nombre="";$id="";
        $codigo_forum=$items_tema['instance'];  
      }  
...
<div class="card overflow-hidden mb-3">
            ...
            <div class="card-body fs--1 p-0">
                ...
                <iframe src="https://cursos.cuyosoft.me/moodle/mod/forum/discuss_pp.php?d=<?php echo $id_cuestionario;?><?php echo  $primer_post;?>" style="width:100%; height:800px" frameborder="0"></iframe>
