                    ...
                    <div class="card" >
                        ...
                        <table class="table table-hover c_table themee-color" >
                           ...
                           for ( $i = 0; $i < count($tema); $i++ ) {   ?>
                            <tr>
                                    <td><?php echo $i+1;?></td>
                                    <td><strong><a href="area_cursos_item.php?tema=<?php echo $tema_id[$i]['id'];?>&curso=<?php echo $curso_enrolado;?>" style="color:black;"><?php echo $tema[$i]['nombre'];?></a></strong></td>
                                    <td></td>
                                    <td></td>
                                    <td>
                                    <a href="area_cursos_item.php?tema=<?php echo $tema_id[$i]['id'];?>&curso=<?php echo $curso_enrolado;?>">    
                                    <button class="btn" style="color:white;background-color: #004c45;" >ACCEDER</button></a>
                                    </td>
                                </tr>
                            <?php }?>
                            </tbody>
